...
(
    ...
    currency_dictionary_code VARCHAR(255)                            NOT NULL,
    CONSTRAINT pk_exchange_rate PRIMARY KEY (id)
);

ALTER TABLE exchange_rate ADD CONSTRAINT FK_EXCHANGE_RATE_ON_CURRENCY_DICTIONARY_CODE FOREIGN KEY (currency_dictionary_code) REFERENCES currency_dictionary (code);
...
ALTER TABLE currency_exchange ADD CONSTRAINT FK_CURRENCY_EXCHANGE_ON_EXCHANGE_RATE FOREIGN KEY (exchange_rate_id) REFERENCES exchange_rate (id);
